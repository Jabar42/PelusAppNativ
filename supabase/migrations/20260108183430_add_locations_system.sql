...
-- Modelo Diamante: Un usuario puede trabajar en múltiples sedes con roles diferentes
...
-- ============================================
-- 5. POLÍTICAS RLS PARA locations
-- ============================================
...
-- ============================================
-- 6. POLÍTICAS RLS PARA user_location_assignments
-- ============================================
...
-- ============================================
-- 8. TRIGGER DE VALIDACIÓN: "SEDE HUÉRFANA"
-- ============================================
-- Previene eliminar una sede que tiene registros médicos asociados
...
BEGIN
  ...
  -- Esta función debe actualizarse cuando se agreguen nuevas tablas de negocio
